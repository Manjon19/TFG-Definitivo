...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 10-06-2023 a las 21:20:50
...
--
-- Base de datos: `autoescuelamanjon`
--
...
('00000000A', 'David', 25, 50, 'B'),
('00000000P', 'DavidP', 15, 52, 'B'),
('00000000X', 'Gerardo', 26, 51, 'B');
...
(0, '', NULL, NULL, NULL),
(1, '20% de descuento si eliges esta oferta con este profesor en las prácticas.', '2033-06-30', 20, '00000000A'),
(2, 'Con esta oferta obtendrás un descuento por realizar las prácticas con un coche especifico.', '2033-06-30', 10, '00000000X');
...
('00000000A', 'Elias', '$2y$10$cldH0VhUBjAc.ZwI2ll1mevMWaNReduyU0h18M7lbmQJlH9SPwoNq', 0, 1, '00000000A'),
('00000000B', 'Pepe', '$2y$10$fZailw.CYnA7tRyfTBC/NeZTP9MdU2H/T2tLZ0DlB1AK9w8AVijAG', 0, 0, '00000000X'),
('00000000M', 'Admin', '$2y$10$6WpGnp52Wjn75NsaA43DW.E8I8CgiKhocMKy4XFzcnJiG52jr.B22', 1, NULL, ''),
...
(50, 'Turismo', 'Volkswaggen', 'golf', 'golf6.jpg', 'B'),
(51, 'Turismo', 'Ranault', 'Megane', 'megane2012.jpg', 'B'),
(52, 'Turismo', 'Volkswagen', 'Golf', 'golf_VII.jpg', 'B');
...
--
ALTER TABLE `t_ofertas`
  ADD CONSTRAINT `t_ofertas_ibfk_1` FOREIGN KEY (`dni_prof`) REFERENCES `profesores` (`dni`) ON DELETE NO ACTION ON UPDATE NO ACTION;
